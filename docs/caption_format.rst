...
Caption format
==============
tg-up has a argument to add a message with every file you send. This is the **caption argument**. The
...
.. code-block:: bash
    ...
    $ tg-up --caption "This is a file with name {file.name}" file.txt
...
.. code-block:: bash
    ...
    $ python -m tg_up.caption_formatter file.txt "{file.absolute}"
