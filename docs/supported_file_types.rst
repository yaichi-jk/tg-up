...
====================
tg-up supports uploading of any file type supported by Telegram. This includes all common image formats,
...
request to the repository <https://github.com/yaichi-jk/tg-up/pulls>`_.
...
Error uploading the file. See the `issue #204 <https://github.com/yaichi-jk/tg-up/issues/204>`_
