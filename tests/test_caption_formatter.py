...
from tg_up.caption_formatter import Duration, FileSize, FileMedia, FilePath, CHUNK_SIZE, CaptionFormatter, \
    test_caption_format
...
class TestFileMedia(unittest.TestCase):
    ...
    @patch("tg_up.caption_formatter.video_metadata")
...
class TestFilePath(unittest.TestCase):
    ...
    @patch("tg_up.caption_formatter.hashlib")
    ...
    @patch("tg_up.caption_formatter.os.stat")
    ...
    @patch("tg_up.caption_formatter.datetime")
    ...
    @patch("tg_up.caption_formatter.FileSize")
    @unittest.skipIf(sys.version_info < (3, 8), "Python 3.7 is not supported.")
    ...
    @patch("tg_up.caption_formatter.FileMedia")
    ...
    @patch("tg_up.caption_formatter.mimetypes")
    ...
    @patch("tg_up.caption_formatter.Path.cwd")
...
class TestTestCaptionFormat(unittest.TestCase):
    ...
    @patch("tg_up.caption_formatter.print")
