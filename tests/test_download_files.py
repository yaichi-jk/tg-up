...
from tg_up.download_files import pipe_file, CHUNK_FILE_SIZE, JoinStrategyBase, UnionJoinStrategy, \
...
class TestUnionJoinStrategy(unittest.TestCase):
    ...
    @patch("tg_up.download_files.JoinStrategyBase.add_download_file")
    ...
    @patch('builtins.open')
    @patch('tg_up.download_files.os')
    @patch('tg_up.download_files.pipe_file')
...
class TestGetJoinStrategy(unittest.TestCase):
    def test_get_join_strategy(self):
        ...
        with patch("tg_up.download_files.JOIN_STRATEGIES", strategies):
...
class TestJoinDownloadSplitFiles(unittest.TestCase):
    @patch("tg_up.download_files.get_join_strategy")
