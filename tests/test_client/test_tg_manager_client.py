...
from tg_up.client import TelegramManagerClient
from tg_up.client.tg_manager_client import phone_match, parse_proxy_string, USER_MAX_FILE_SIZE, \
    BOT_USER_MAX_FILE_SIZE, PREMIUM_USER_MAX_FILE_SIZE, USER_MAX_CAPTION_LENGTH, PREMIUM_USER_MAX_CAPTION_LENGTH
from tg_up.config import SESSION_FILE
from tg_up.exceptions import TelegramProxyError
...
class TestTelegramManagerClient(unittest.TestCase):
    ...
    @patch('tg_up.client.tg_upload_client.TelegramUploadClient.__init__')
    ...
    @patch('builtins.open', mock_open(read_data=json.dumps(CONFIG_DATA)))
    @patch('tg_up.client.tg_upload_client.TelegramUploadClient.__init__')
    @patch('tg_up.client.tg_upload_client.TelegramUploadClient.start')
    ...
    @patch('builtins.open', mock_open(read_data=json.dumps(CONFIG_DATA)))
    @patch('tg_up.client.tg_manager_client.TelegramManagerClient.__init__', return_value=None)
    @patch('tg_up.client.tg_manager_client.TelegramManagerClient.get_me')
    ...
    @patch('builtins.open', mock_open(read_data=json.dumps(CONFIG_DATA)))
    @patch('tg_up.client.tg_manager_client.TelegramManagerClient.__init__', return_value=None)
    @patch('tg_up.client.tg_manager_client.TelegramManagerClient.me')
