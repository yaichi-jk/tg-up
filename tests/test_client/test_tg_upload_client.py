...
from tg_up.exceptions import TelegramUploadDataLoss, MissingFileError
...
class TestTelegramUploadClient(IsolatedAsyncioTestCase):
    ...
    @patch('tg_up.client.tg_upload_client.TelegramClient.__init__', return_value=None)
    ...
    @patch("tg_up.client.tg_upload_client.TelegramUploadClient.forward_messages")
    ...
    @patch('tg_up.client.tg_upload_client.TelegramUploadClient.send_files')
    @patch('tg_up.client.tg_upload_client.TelegramUploadClient._send_album_media')
    ...
    def test_send_files(self):
        ...
        with self.subTest("Test send files with thumb"), \
                ...
                patch('tg_up.client.tg_upload_client.os') as mock_os:
    ...
    @patch('tg_up.client.tg_upload_client.utils')
    ...
    async def test_send_media(self, mock_utils: MagicMock):
        ...
        file = File(mock_client, self.upload_file_path)
        with patch('tg_up.client.tg_upload_client.isinstance', return_value=True), \
        ...
        with patch('tg_up.client.tg_upload_client.isinstance',
