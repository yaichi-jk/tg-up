...
CONFIG_DIRECTORY = os.environ.get('TG_UP_CONFIG_DIRECTORY', '~/.config')
CONFIG_FILE = os.path.expanduser('{}/tg-up.json'.format(CONFIG_DIRECTORY))
SESSION_FILE = os.path.expanduser('{}/tg-up'.format(CONFIG_DIRECTORY))
