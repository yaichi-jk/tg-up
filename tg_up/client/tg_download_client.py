...
from tg_up.download_files import DownloadFile
from tg_up.exceptions import TelegramUploadNoSpaceError
from tg_up.utils import free_disk_usage, sizeof_fmt, get_environment_integer


if sys.version_info < (3, 10):
    from tg_up._compat import anext


PARALLEL_DOWNLOAD_BLOCKS = get_environment_integer('TG_UP_PARALLEL_DOWNLOAD_BLOCKS', 10)
